	...
	public SendDemoForm(SendDemo snddm) {
		...
		btnSendFinish.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				java.sql.Date datesend = new java.sql.Date(utildatesend.getTime());
				java.sql.Date dateexp = new java.sql.Date(utildateexp.getTime());
		...
		expdateF.setDate(new Date(utilDate.getTime() + (14*24*60*60*1000)));
	}
}
